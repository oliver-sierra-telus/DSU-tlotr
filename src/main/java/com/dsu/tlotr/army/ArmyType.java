...
public enum ArmyType {
    HEROES(2, new Limit(60, 100), new CharacterType[] { HUMAN, ELVE, HOBBIT, CREATURE }),
    BEASTS(1, new Limit(50, 90), new CharacterType[] { ORC, GOBLIN, CREATURE });

    private final int NUMBER_DICES;
    private final Limit SHIELD_LIMIT;
    private final CharacterType[] CHARACTERS_TYPES;

    ArmyType(int numberDices, Limit shieldLimit, CharacterType[] characterTypes) {
        this.NUMBER_DICES = numberDices;
        this.SHIELD_LIMIT = shieldLimit;
